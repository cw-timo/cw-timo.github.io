...
var _this = this;
import { io, ones, scalar, sum, tensor1d, tensor2d, zeros } from '@tensorflow/tfjs-core';
...
describeMathCPU('model_from_json', function () {
    ...
    it('toJSON return value includes correct versions', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, modelFromJSON(fakeRoundtripModel)];
                case 1:
                    model = _a.sent();
        ...
        return __generator(this, function (_a) {
            ...
            spyOn(window, 'fetch').and.callFake(function (path) {
                if (path === 'model/model.json') {
                    ...
                    return new Response(ones([32, 32], 'float32').dataSync());
                }
                else if (path === 'model/weight_1') {
                    return new Response(zeros([32], 'float32').dataSync());
                }
                else {
        ...
        return __generator(this, function (_a) {
            ...
            spyOn(window, 'fetch').and.callFake(function (path) {
                if (path === 'model/model.json') {
                    ...
                    return new Response(ones([10, 2], 'float32').dataSync());
                }
                else if (path === 'model/weight_1') {
                    return new Response(zeros([2], 'float32').dataSync());
                }
                else if (path === 'model/weight_2') {
                    return new Response(zeros([2, 1], 'float32').dataSync());
                }
                else if (path === 'model/weight_3') {
                    return new Response(ones([1], 'float32').dataSync());
                }
                else {
                    throw new Error("Invalid path: " + path);
                }
