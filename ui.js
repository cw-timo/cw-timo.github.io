...
<html lang="en">
  ...
  <title>beginner-tensorflowjs-examples-in-javascript/ui.js at master · hpssjellis/beginner-tensorflowjs-examples-in-javascript</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjE5OTUwODY0OjNiZjBjOGMwMjcwZDk0NGM2ZmJhZDA3NDYxYWQzNmYwNTJiMDlmMDY3ZDk2Zjk0ZDAzYjJhZGZiMTdlODM0NmY=--9ddc57aab5fb5bfd49c0446c1da431130c03af0b">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="ECE6:031E:2BD3FFB:514E7B7:5B158052" data-pjax-transient>
...
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="octolytics-dimension-user_id" content="5605614" /><meta name="octolytics-dimension-user_login" content="hpssjellis" /><meta name="octolytics-dimension-repository_id" content="127588269" /><meta name="octolytics-dimension-repository_nwo" content="hpssjellis/beginner-tensorflowjs-examples-in-javascript" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="127588269" /><meta name="octolytics-dimension-repository_network_root_nwo" content="hpssjellis/beginner-tensorflowjs-examples-in-javascript" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/hpssjellis/beginner-tensorflowjs-examples-in-javascript/blob/master/tf-examples/translation/ui.js" data-pjax-transient>
...
<link rel="manifest" href="/manifest.json" crossOrigin="use-credentials">
  ...
  Microsoft is acquiring GitHub! <a href="https://blog.github.com/2018-06-04-github-microsoft/" class="text-bold text-white" data-ga-click="MS banner, click, link - text:Read our blog">Read our blog</a> and <a href="https://blogs.microsoft.com/?p=52553832" class="text-bold text-white" data-ga-click="MS banner, click, link - text:Satya Nadella's post">Satya Nadella's post</a> to learn more.
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-remote="true" class="js-notice-dismiss" action="/settings/dismiss-notice/generic_site_banner" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="kns+dp5NRnoGlrrzQUkvYaPRutXM+2iG43ETKWnh1XNizXljC/O++jjtqRNALcip08yZpLACpFjtuzomOTMDpg==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="127588269" data-scoped-search-url="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/search" data-unscoped-search-url="/search" action="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=JPksY9RDnT55L4BmiUUjyCfGUbW0oyTnMMaIVG/tjzapyrgzKMbaC3OG7nBsRTjRqO2naPFA+0796wj6Ykj08Q=="
          spellcheck="false"
          autocomplete="off"
          autocapitalize="off"
          >
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown">
    ...
    <details class="details-expanded details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="1EbT5YtRA9FCs6Bl77W06KvS94cTeT5IuNu7LM202YW+It//Y+ndZLmCeASiTkDaiQ3my2u31yT1toVZyeNeHg==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="FEpeezod363qSM/ZQqne0zo1ZJr3JvAfwSFf+G6SAaB+LlJh0qUBGBF5F7gPUirhGOp11o/oGXOMTGGNasWGOw==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="oD0872L68Mjt4vclnp/Hs44tJVI0bVRuKFHJ3rhvWcx0IqeFfUHmOy1oR6j76SuZJjcBLr5rPrvxr1Nh5ymQ5Q==" />      <input type="hidden" name="repository_id" id="repository_id" value="127588269" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="guJYydPohqKUvfPwtyzv9vm8pIVmIvnXnn0COCIBdKW+1oKEJFpYPv8hC2F2+FhfUOY5fOVh3hXF9Sk78AfeYw==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="s9gfPplkzGFUwnF7j/eYxWvcdKe/E03OUXNOEwlQ+GLWWqq7ToKki7UBwquLpRc4zIFUQ8d72i4DBzJkPbgT6Q==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/blob/b41e1325c8b75f0a88899fb8c28eb1b880a6de92/tf-examples/translation/ui.js">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:d18bcf4916848d522af8f8864b342149 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/blob/master/tf-examples/translation/ui.js"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
  ...
  <include-fragment src="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/contributors/master/tf-examples/translation/ui.js" class="commit-tease">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/raw/master/tf-examples/translation/ui.js">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/blame/master/tf-examples/translation/ui.js">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/commits/master/tf-examples/translation/ui.js">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/edit/master/tf-examples/translation/ui.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="gGCJhpV2t9Z0bTV0ZXPUPwUToUPHWkB/PgFPY7LJErLCgThg/CLjoQKedlWeJ0p7jJk4liqab5AakgFwnEjZLg==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/delete/master/tf-examples/translation/ui.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="aqjZW6H+9HexLqfMKZh+2dcFiAFLLi4lcb8TdRjFIkEwAnsZihHjOIhfU+GlWdrvKh9K2XcLpb7/N/HCZstJpw==" />
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC19" class="blob-code blob-code-inner js-file-line"><span class="pl-k">var</span> ui <span class="pl-k">=</span> ui <span class="pl-k">||</span> {}</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC24" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">ui</span>.<span class="pl-en">status</span> <span class="pl-k">=</span> <span class="pl-k">function</span>(<span class="pl-smi">statusText</span>) {</td>
      </tr>
      <tr>
        <td id="L25" class="blob-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-code blob-code-inner js-file-line">  <span class="pl-en">console</span>.<span class="pl-c1">log</span>(statusText);</td>
      </tr>
      <tr>
        <td id="L26" class="blob-num js-line-number" data-line-number="26"></td>
        <td id="LC26" class="blob-code blob-code-inner js-file-line">  <span class="pl-c1">document</span>.<span class="pl-c1">getElementById</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>status<span class="pl-pds">&#39;</span></span>).<span class="pl-smi">textContent</span> <span class="pl-k">=</span> statusText;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC29" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">ui</span>.<span class="pl-en">setEnglish</span> <span class="pl-k">=</span> <span class="pl-k">function</span>(<span class="pl-smi">text</span>, <span class="pl-smi">translate</span>) {</td>
      </tr>
      <tr>
        <td id="L30" class="blob-num js-line-number" data-line-number="30"></td>
        <td id="LC30" class="blob-code blob-code-inner js-file-line">  <span class="pl-c1">document</span>.<span class="pl-c1">getElementById</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>englishSentence<span class="pl-pds">&#39;</span></span>).<span class="pl-c1">value</span> <span class="pl-k">=</span> text;</td>
      </tr>
      <tr>
        <td id="L31" class="blob-num js-line-number" data-line-number="31"></td>
        <td id="LC31" class="blob-code blob-code-inner js-file-line">  <span class="pl-c1">document</span>.<span class="pl-c1">getElementById</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>frenchSentence<span class="pl-pds">&#39;</span></span>).<span class="pl-smi">textContent</span> <span class="pl-k">=</span> <span class="pl-en">translate</span>(text);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC34" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">ui</span>.<span class="pl-en">setTranslationFunction</span> <span class="pl-k">=</span> <span class="pl-k">function</span>(<span class="pl-smi">translate</span>) {</td>
      </tr>
      <tr>
        <td id="L35" class="blob-num js-line-number" data-line-number="35"></td>
        <td id="LC35" class="blob-code blob-code-inner js-file-line">  <span class="pl-k">const</span> <span class="pl-c1">englishElement</span> <span class="pl-k">=</span> <span class="pl-c1">document</span>.<span class="pl-c1">getElementById</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>englishSentence<span class="pl-pds">&#39;</span></span>);</td>
      </tr>
      <tr>
        <td id="L36" class="blob-num js-line-number" data-line-number="36"></td>
        <td id="LC36" class="blob-code blob-code-inner js-file-line">  <span class="pl-smi">englishElement</span>.<span class="pl-c1">addEventListener</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>input<span class="pl-pds">&#39;</span></span>, (<span class="pl-smi">e</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L37" class="blob-num js-line-number" data-line-number="37"></td>
        <td id="LC37" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">const</span> <span class="pl-c1">inputSentence</span> <span class="pl-k">=</span> <span class="pl-smi">englishElement</span>.<span class="pl-c1">value</span>;</td>
      </tr>
      <tr>
        <td id="L38" class="blob-num js-line-number" data-line-number="38"></td>
        <td id="LC38" class="blob-code blob-code-inner js-file-line">    <span class="pl-c1">document</span>.<span class="pl-c1">getElementById</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>frenchSentence<span class="pl-pds">&#39;</span></span>).<span class="pl-smi">textContent</span> <span class="pl-k">=</span></td>
      </tr>
      <tr>
        <td id="L39" class="blob-num js-line-number" data-line-number="39"></td>
        <td id="LC39" class="blob-code blob-code-inner js-file-line">        <span class="pl-en">translate</span>(inputSentence);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC43" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">ui</span>.<span class="pl-en">disableLoadModelButtons</span> <span class="pl-k">=</span> <span class="pl-k">function</span>() {</td>
      </tr>
      <tr>
        <td id="L44" class="blob-num js-line-number" data-line-number="44"></td>
        <td id="LC44" class="blob-code blob-code-inner js-file-line">  <span class="pl-c1">document</span>.<span class="pl-c1">getElementById</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>load-pretrained-remote<span class="pl-pds">&#39;</span></span>).<span class="pl-c1">style</span>.<span class="pl-c1">display</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>none<span class="pl-pds">&#39;</span></span>;</td>
      </tr>
      <tr>
        <td id="L45" class="blob-num js-line-number" data-line-number="45"></td>
        <td id="LC45" class="blob-code blob-code-inner js-file-line">  <span class="pl-c1">document</span>.<span class="pl-c1">getElementById</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>load-pretrained-local<span class="pl-pds">&#39;</span></span>).<span class="pl-c1">style</span>.<span class="pl-c1">display</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>none<span class="pl-pds">&#39;</span></span>;</td>
      </tr>
      <tr>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" href="/hpssjellis/beginner-tensorflowjs-examples-in-javascript/blame/b41e1325c8b75f0a88899fb8c28eb1b880a6de92/tf-examples/translation/ui.js">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.25459s from unicorn-5b57f8874f-rnmjs">GitHub</span>, Inc.</li>
